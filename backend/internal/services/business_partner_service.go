...
func (s *businessPartnerService) GetByID(id int, businessPartnerTIN string) (*models.BusinessPartner, error) {
	return s.repo.GetByID(id, businessPartnerTIN)
}

func (s *businessPartnerService) GetByName(name string, businessPartnerTIN string) (*models.BusinessPartner, error) {
	return s.repo.GetByName(name, businessPartnerTIN)
}
